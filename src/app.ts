...
app.use(
  cors({
    origin: [
      "http://localhost:3000",
      "https://apixcel-frontend-five.vercel.app",
    ],
    credentials: true,
  })
);
...
app.get("/", (req: Request, res: Response) => {
  res.send(`<div style="
    ...
    >
     ...
     >
        <h1 style="font-size: 3em; color: #333;">Welcome to APIXcel Server</h1>
        ...
        <a href="https://github.com/nurullah91/apixcel-task-backend" style="
